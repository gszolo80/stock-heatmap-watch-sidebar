// 新浪交易日历解码器（来自 akshare hk_js_decode，仅用于解码新浪 klc_td_sh.txt 返回的 datelist）
// 原始混淆代码原样保留，仅用 IIFE 包裹避免污染全局，导出 window.SinaDateDecode(datelist) -> Date[]
window.SinaDateDecode = (function () {
